...
export class Reactor {
    ...
    updateElectricityOutput(currentFuelInputLevel, currentCoolingLevel) {
        ...
        // Update Temperature
        this.currentTemperature = this.calculateTemperature(
            this.currentTemperature,
            this.currentFuelInputLevel,
            this.currentCoolingLevel
        )
        this.temperatureHistory.push(this.currentTemperature)

        // Update Electricity Output
        this.currentElectricityOutput = this.calculateElectricityOutput(
            this.currentTemperature,
            this.currentFuelInputLevel
        )
