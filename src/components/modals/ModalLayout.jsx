    ...
    return (
            <div className={`modal ${props.showModal ? 'show' : ''}`}>
                ...
                >
                    ...
                    {/*content*/}
                        <div className="modal--content shadow-lg relative flex flex-col w-full bg-neutral-600 border-solid border-2 border-gray-900 outline-none focus:outline-none">
                            {/*header*/}
