    ...
    return (
            <div className={`modal ${props.showModal ? 'show' : ''}`}>
                ...
                >
                    ...
                    {/*content*/}
                        <div className="md:min-h-fit md:min-w-fit min-h-[100vh] min-w-[100vw] shadow-lg relative flex flex-col w-full bg-neutral-600 border-solid border-2 border-gray-900 outline-none focus:outline-none">
                            {/*header*/}
