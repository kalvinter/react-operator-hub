...
export default function ModalLayout(props) {
    ...
    return (
        <div className={`modal ${showModal ? 'show' : ''}`}>
            <div className="justify-center modal--body items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                <div className="relative w-auto my-6 mx-auto max-w-3xl">
                    {/*content*/}
                    <div className="md:min-h-fit md:min-w-fit min-h-[100svh] min-w-[100svw] shadow-lg relative flex flex-col w-full bg-card border-solid border-2 border-gray-900 outline-none focus:outline-none">
                        {/*header*/}
